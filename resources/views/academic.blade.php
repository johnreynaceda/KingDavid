...
@section('main')
    ...
    <div class=" relative bg-white shadow-lg p-2 text-main1">
        ...
        <h1 class="text-2xl font-sans font-extrabold mt-5">ACADEMICS</h1>
        <h1 class="text-lg font-sans font-bold underline mt-5">Course Offered:</h1>
        <h1 class="text-lg font-sans font-bold mt-2">Nursery - Ages 2 1/2 to 3 years old</h1>
        <h1 class="text-lg font-sans font-bold mt-2">Kinder I - Ages 3 1/2 to 4 years old</h1>
        <h1 class="text-lg font-sans font-bold mt-2">Kinder II - Ages 4 1/2 to 5 years old</h1>
        <h1 class="text-lg font-sans font-bold mt-2">Grade I to VI</h1>
