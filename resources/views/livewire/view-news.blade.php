<div>
    <div class="bg-white hidden lg:block relative rounded-lg shadow-lg text-main1 p-2">
        <div class="title">
            <h1 class="text-lg font-bold">{{$news->title}}</h1>
        </div>
...
<span class=" text-sm">{{ $news->created_at->format('M d, Y') }}</span>
           ...
           <div class="image mt-5">
               <img src="{{ asset('storage/announcement/' . $news->image->url) }}" class="h-96 w-full rounded-lg" alt="">
           </div>

           <div class="mt-5">
                <p class="text-justify leading-loose">{{ $news->content }}</p>
           </div>
    </div>
...
<span class=" text-sm">{{ $news->created_at->format('M d, Y') }}</span>
           ...
           <div class="image mt-5">
               <img src="{{ asset('storage/announcement/' . $news->image->url) }}" class="h-72 w-full rounded-lg" alt="">
           </div>
