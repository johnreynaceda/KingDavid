...
@section('main')
    ...
    <div class=" relative bg-white shadow-lg p-2 text-main1">
        ...
        <div class="img mt-5 flex justify-center">
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/94/King_David%2C_the_King_of_Israel.jpg/220px-King_David%2C_the_King_of_Israel.jpg"
                class="h-80 w-80 rounded-lg shadow-lg transition duration-500 ease-in-out bg-blue-600 hover:bg-red-600 transform hover:-translate-y-1 hover:scale-100"
                alt="">
        </div>

        <h1 class="text-2xl font-sans font-extrabold mt-5">MESSAGE OF THE PRESIDENT</h1>
...
@section('mobile')
    <div class=" relative bg-white shadow-lg p-2 text-main1 lg:hidden">
        ...
        <h1 class="text-xl font-sans text-center font-extrabold mt-5">MESSAGE OF THE PRESIDENT</h1>
