...
@section('main')
    ...
    <div class=" relative bg-white shadow-lg p-2 text-main1">
        <h1 class="text-2xl font-sans font-extrabold">THE SCHOOL</h1>
        <div class="img mx-5 mt-10">
            <img src="{{ asset('images/KDIBackground.jpg') }}"
                class="h-80 rounded-lg shadow-lg transition duration-500 ease-in-out bg-blue-600 hover:bg-red-600 transform hover:-translate-y-1 hover:scale-100"
                alt="">
        </div>
...
@section('mobile')
    <div class=" relative bg-white shadow-lg p-2 text-main1 lg:hidden">
        ...
        <div class="img mx-5 mt-5">
            <img src="{{ asset('images/KDIBackground.jpg') }}"
                class="h-56 rounded-lg shadow-lg transition duration-500 ease-in-out bg-blue-600 hover:bg-red-600 transform hover:-translate-y-1 hover:scale-100"
                alt="">
        </div>
        <div class="img mx-5 mt-5">
            <p class="leading-loose text-justify">
